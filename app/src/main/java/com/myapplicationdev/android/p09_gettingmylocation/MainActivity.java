...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnLocationGet, btnLocationRemove, btnCheckRecords;
    GoogleMap map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLocationGet = findViewById(R.id.btnLocationGet);
        ...
        LocationCallback locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                coordinatesTV.setText(textFrom(location));
                ...
                if (currentLocationMarker == null) {
                    ...
                    map.moveCamera(CameraUpdateFactory.newLatLngZoom(coordinatesFrom(location), 16));
                }
                else {
                    currentLocationMarker.setPosition(coordinatesFrom(location));
                    map.moveCamera(CameraUpdateFactory.newLatLng(coordinatesFrom(location)));
                }
        ...
        btnLocationGet.setOnClickListener(view -> {
        ...
        btnLocationRemove.setOnClickListener(view -> {
            if (checkLocationPermission()) {
        ...
        btnCheckRecords.setOnClickListener(view -> {
